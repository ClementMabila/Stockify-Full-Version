      ...
      <div id="dashboard" class="d-flex vh-100">
        ...
        <div class="sidebar">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <router-link to="/stock-history" class="nav-link"><span><img src="../assets/images/d-icon-h.png" alt="Google Icon" class="icon-side" /></span>Stock History</router-link>
            </li>
            <li class="nav-item">
              <router-link to="/inventory" class="nav-link"><span><img src="../assets/images/d-icon-4.png" alt="Google Icon" class="icon-side" /></span>Inventory</router-link>
            </li>
          </ul>
        </div>

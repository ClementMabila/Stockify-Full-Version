    ...
    <div class="profile-header-content">
      ...
      <div class="user-info">
        ...
        <div class="user-stats">
          ...
          <div class="stat-item">
            <span class="stat-value">{{ investorCount }}</span>
...
<div class="details-content">
  ...
  <div class="details-card profile-info-card">
    <div class="details-card-header">
      ...
      <button class="edit-button" @click="editMode = !editMode">
        ...
        <img v-if="!editMode" src="../assets/images/white-edit.svg" alt="Edit" width="16" height="16" />
  ...
  <div class="details-card organization-card">
    ...
    <div class="org-details-grid">
      ...
      <div class="detail-item">
        <div class="detail-content">
          <span class="detail-label">Organisation Members</span>
          <span class="detail-value">
            <div class="members-list">
            <select v-model="selectedReceiver" class="members-select">
  ...
  setup() {
    ...
    const viewProfile = () => {
      if (selectedReceiver.value) {
        router.push(`/ShowProfile/${selectedReceiver.value}`);
      }
    };
    ...
    const fetchInvestorCount = async () => {
      try {
        const response = await http.get('/api/organization/investors-count/');
        investorCount.value = response.investor_count;
        console.log('Investor Count:', investorCount.value);
      } catch (error) {
    ...
    const fetchUserProfile = async (userId) => {
      try {
        const profileData = await http.get(`/api/user-profile/${userId}/`);
    ...
    const fetchOrganizationMembers = async () => {
      try {
        ...
        console.log('Organization members:', organizationMembers.value);
      } catch (error) {
    ...
    try {
      const response = await fetch('http://localhost:8000/api/user-rating/', {
          method: 'GET',
          headers: {
            'X-CSRFToken': getCSRFToken(),
          },
